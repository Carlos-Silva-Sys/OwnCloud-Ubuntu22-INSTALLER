...
| Plataforma | Enlace |
|------------|--------|
| 🖥️ **Escritorio** (Windows / Linux / Mac) | [owncloud.com/desktop-app/](https://owncloud.com/desktop-app/) |
| 📱 **Móvil** (Android / iOS) | [owncloud.com/mobile-apps/](https://owncloud.com/mobile-apps/) |
